...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return { title: dict.categoryPages.modern.metaTitle };
}
...
export default async function ModernPage({
  ...
  return (
    <div>
      <CategoryPageHeader
        title={dict.nav.modern}
        description={dict.categoryPages.modern.description}
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <ProductGrid jerseys={filtered} emptyMessage={dict.categoryPages.modern.empty} />
      </div>
    </div>
  );
}
